...
CREATE TABLE  `o2o_bis` (
  ...
  `corporation_tel` VARCHAR(20) NOT NULL DEFAULT ' ',
  `listorder` int(8) unsigned NOT NULL DEFAULT 0,
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `create_time` int(11) unsigned NOT NULL DEFAULT 0,
  `update_time` int(11) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE  `o2o_bis_location` (
  ...
  `bis_id` VARCHAR(20) NOT NULL DEFAULT 0,
  ...
  `category_path` VARCHAR(20) NOT NULL DEFAULT ' ',
  `bank_info` VARCHAR(50) NOT NULL DEFAULT ' ',
  `listorder` int(8) unsigned NOT NULL DEFAULT 0,
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `create_time` int(11) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `o2o_deal` (
  ...
  `location_ids` VARCHAR(100) NOT NULL DEFAULT ' ' COMMENT '所属商家的店铺数据',
...
CREATE TABLE `o2o_featured` (
  ...
  `title` VARCHAR(30) NOT NULL DEFAULT ' ' COMMENT '推荐位分类',
...
CREATE TABLE `o2o_order` (
  ...
  `payment_id` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1代表微信支付',
  `deal_id` int(11) NOT NULL DEFAULT 0,
  `deal_count`int(11) NOT NULL DEFAULT 0,
  `pay_status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '支付状态，0未支付1支付成功2失败',
